...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <p class="text-muted">Price: <?php echo htmlspecialchars($propertyDetail["price"], ENT_QUOTES, 'UTF-8'); ?></p>
        <p class="text-muted">Owner: <?php echo htmlspecialchars($propertyDetail["owner_name"], ENT_QUOTES, 'UTF-8'); ?></p>
