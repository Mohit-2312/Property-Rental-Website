...
$app->get('/property/{uid}/contract', function (Request $request, Response $response, $args) use ($app){    
    ...
    $data.='<br><br>PURCHASE PRICE: <b>"' . htmlspecialchars($propertyDetail["price"], ENT_QUOTES, 'UTF-8') . '"/- Rs</b> <br><br>The Buyer agrees to purchase the property described above from the Seller for the total purchase price of <b>"' . htmlspecialchars($propertyDetail["price"], ENT_QUOTES, 'UTF-8') . '"</b> /- Rs (the "Purchase Price"). <br><br>ENTIRE AGREEMENT:<br> This Contract represents the entire agreement between the parties, superseding all prior and contemporaneous understandings, agreements, representations, and warranties. <br><br><br><br><b>'.htmlspecialchars($_SESSION["full_name"], ENT_QUOTES, 'UTF-8').'</b> <br><b>'.$userType."</b>";
